...
namespace Engine.Core
{
    ...
    {
        /// <summary>
        /// The public readonly directory, generated by the installer
        /// </summary>
        ...
        /// <returns></returns>
        internal (uint,uint)[] PollBatch(byte BatchSize)
        {
        ...
        internal string[] ScoringItems
        {
            get
            {
                ...
                {
                    EXPECTED[id].ID = id; //this is just due to bad design, which i can fix eventually TODO
        ...
        /// <summary>
        /// Gets the number of checks in the engine
        /// </summary>
        internal int Count
        {
            get
